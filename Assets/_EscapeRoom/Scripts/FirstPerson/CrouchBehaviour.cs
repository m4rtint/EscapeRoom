...
namespace EscapeRoom
{
    public class CrouchBehaviour : MonoBehaviour
    {
        ...
        [HideInInspector] public float defaultCapsuleColliderHeight;
            ...
            if (IsKeyPressed(keys))
            {
                ...
                if (capsuleCollider)
                {
                    capsuleCollider.height =
                        defaultCapsuleColliderHeight - (defaultHeadYLocalPosition - crouchYLocalPosition);
        ...
        private static bool IsKeyPressed(KeyCode[] keys)
        {
